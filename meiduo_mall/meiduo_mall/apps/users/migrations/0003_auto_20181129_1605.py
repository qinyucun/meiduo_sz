# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-11-29 08:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, default='', max_length=30, null=True, verbose_name='电子子邮箱')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to=settings.AUTH_USER_MODEL, verbose_name='用用户')),
            ],
            options={
                'verbose_name': '用用户地址',
                'verbose_name_plural': '用用户地址',
                'db_table': 'tb_address',
